        ...
        <main className="bg-[url('/images/bg-main.svg')] bg-cover">
            ...
            <section className="main-section">
                <div className="page-heading py-16">
                    <h1>Retroalimentacion inteligente de tu CV</h1>
                    {isProcessing ? (
                        <>
                            <h2>{statusText}</h2>
                        ...
                        <h2>Sube tu CV para recibir retroalimentacion</h2>
                    )}
                    {!isProcessing && (
                        <form id="upload-form" onSubmit={handleSubmit} className="flex flex-col gap-4 mt-8">
                            ...
                            <div className="form-div">
                                ...
                                <input type="text" name="job-title" placeholder="Título del puesto" id="job-title" />
                            </div>
                            <div className="form-div">
                            ...
                            <div className="form-div">
                                <label htmlFor="uploader">Subir Hoja de vida</label>
